...
This repository contains sample to display a progress bar using the [SfLinearGauge](https://help.syncfusion.com/winui/linear-gauge/getting-started) control.
