...
This repository contains sample to display a progress bar using the [Syncfusion WinUI Linear Gauge](https://help.syncfusion.com/winui/linear-gauge/getting-started) control.
